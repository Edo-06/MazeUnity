...
public class Container1 : MonoBehaviour
{
    ...
    public int size;
    public static Container1 Instance;
        ...
        while(i < 1)
        {
            ...
            if(Global.maze.mazee[x,z].category == Category.floor && Global.maze.mazee[x1,z1].category == Category.floor)
            {
                foreach(var player in players0)
                {
                    ...
                    newPlayer[0] = InitPlayer(player[0],x,z);
                    newPlayer[1] = InitPlayer(player[1],x1,z1);
    ...
    GameObject InitPlayer(GameObject player1,int x, int z)
    {
    ...
    {
        foreach(var c in SearchCollidersAt(i,j))
        {
